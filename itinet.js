...
function getProfileQuestions(blackList, dependencies){
  ...
  catRequest.onreadystatechange = function(){
    if(catRequest.readyState === 4 && catRequest.status === 200){
      ...
      var formToPost='<div class="advancedSearchQuestion"><label class="advansedSearchLabel" for="q">Find a Translator</label><select class="advansedSearchSelect" id="typeOfMember"><option selected="selected" value="Not specified">Any</option><option>Translator</option><option>Interpreter</option></select></div><div class="advancedSearchQuestion"><label class="advansedSearchLabel" for="q">Working from (language)</label><select class="advansedSearchSelect" id="fromLanguage" "><option selected="selected" value="Not specified">-</option><option value="Albanian">Albanian</option><option value="Croatian">Croatian</option><option value="Dutch">Dutch</option><option value="English">English</option><option value="French">French</option><option value="German">German</option><option value="Italian">Italian</option><option value="Maltese">Maltese</option><option value="Polish">Polish</option><option value="Portuguese">Portuguese</option><option value="Russian">Russian</option><option value="Spanish">Spanish</option></select></div><div class="advancedSearchQuestion"><label class="advansedSearchLabel" for="q">into (language)</label><select class="advansedSearchSelect" id="toLanguage" "><option selected="selected" value="Not specified">-</option><option value="Albanian">Albanian</option><option value="Croatian">Croatian</option><option value="Dutch">Dutch</option><option value="English">English</option><option value="French">French</option><option value="German">German</option><option value="Italian">Italian</option><option value="Maltese">Maltese</option><option value="Polish">Polish</option><option value="Portuguese">Portuguese</option><option value="Russian">Russian</option><option value="Spanish">Spanish</option></select></div>';
      var questionList=[];      
